...
ALTER TABLE `user` ADD CONSTRAINT `usr_user_type_enum_id_fk` FOREIGN KEY (`user_type_enum_id`) REFERENCES `user_type_enum`(`id`) ON DELETE no action ON UPDATE no action;